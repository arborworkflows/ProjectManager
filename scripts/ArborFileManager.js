...
scriptPath = "/" + path.split("/").slice(3, -1).join("/");
scripts = path = undefined;
...
(function ($) {
    ...
    $.fn.arborFileManager = function (options) {
        var e = this.first(),
            opts = $.extend({}, defaults, options),
            ee = d3.select(e.toArray()[0]);

        $.ajax({
            url: scriptPath + "/AFM-template.html",
            dataType: "text",
            success: function (AFMtext) {
                $(AFMtext).appendTo(e);
                ...
                function servicePath(){
                    ...
                    return scriptPath + "/../tangelo/projmgr" + pathArgs;
                }
                ...
                function refreshProjects(fade){
                    ...
                    ajax.send("GET", function (e, projects) {
                        ...
                        .on("click", function (d) {
                            // Move the highlight to the selected project (or
                            // remove the highlight entirely if the selected
                ...
                function refreshDatasets(project, type, fade) {
                    ...
                    fresh.append("a")
                        ...
                        .on("click", function () {
                            d3.event.stopPropagation();
                            opts.onPreview(hl_proj, hl_type, hl_dataset);
                        });
                    ...
                    fresh.append("a")
                        ...
                        .on("click", function () {
                            d3.event.stopPropagation();
                            opts.onSelect(hl_proj, hl_type, hl_dataset);
                        });
